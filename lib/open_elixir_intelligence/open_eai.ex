defmodule OpenElixirIntelligence.OpenEAI do
  use GenServer
  require Logger
  alias OpenElixirIntelligence.RuntimeEvaluator
  alias OpenElixirIntelligence.PromptRepo
  ...
  defp reset() do
    ...
    Phoenix.PubSub.unsubscribe(OpenElixirIntelligence.PubSub, topic_user_message())
  ...
  defp create_user_fix_code_request(
    ...
    Phoenix.PubSub.local_broadcast(
      OpenElixirIntelligence.PubSub,
      OpenElixirIntelligence.OpenEI.topic_user_message(),
  ...
  defp is_it_hotreload_fix_to_be_appliead(response, state) do
    ...
    state =
      if fixed_code != "" do
        ...
        OpenElixirIntelligence.RuntimeEvaluator.apply_hotreload_fix(fixed_code)
