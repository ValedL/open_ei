defmodule OpenElixirIntelligence.PromptRepo do
  ...
  You provide clear answers to the questions and the code you provide is the code that can be executed (ie you don't use functions that do not exist).
  ...
  ** (ArithmeticError) bad argument in arithmetic expression
  (fluffy_train 0.1.0) lib/fluffy_train/divide_by_zero.ex:6: OpenElixirIntelligence.DivideByZero.execute/0
